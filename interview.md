...
- [비동기 프로그래밍](#비동기-프로그래밍)
  ...
  - 동기와 비동기의 차이점에 대해서 설명해줄 수 있나
  - 이벤트 루프와 태스크 큐에 대해서 알고 있나
  - 마이크로태스크 큐에 대해서 알고 있나
...
> ctrl + F '자바스크립트에서 객체를 생성하는 방법은 어떤 것들이 있나'
...
### 다음과 같은 코드에서 이벤트 루프와 태스크 큐가 어떻게 동작하는지 설명해볼 수 있나
...
### `async/await 가 뭔가 기존의 Promise와는 어떤 차이가 있죠?`

[Link MDN: async functio](https://developer.mozilla.org/ko/docs/Web/JavaScript/Reference/Statements/async_function)
